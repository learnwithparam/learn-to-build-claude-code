...
The final module combines everything: task management, worktree creation,
scoped command execution, and lifecycle events for observability.
...
if __name__ == "__main__":
    print(f"Repo root for 12: {REPO_ROOT}")
    ...
    if len(sys.argv) > 1:
        ...
        print(f"\033[36m12 >> \033[0m{query}")
