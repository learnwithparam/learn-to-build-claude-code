...
Teammates now find work themselves instead of waiting for instructions.
The WORK/IDLE lifecycle lets them poll for new tasks during idle periods.
...
class TeammateManager:
    ...
    def _teammate_tools(self) -> list:
        return [
            _to_openai_tool("bash", "Run a shell command.",
                            {"type": "object", "properties": {"command": {"type": "string"}}, "required": ["command"]}),
            _to_openai_tool("read_file", "Read file contents.",
                            {"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]}),
            _to_openai_tool("write_file", "Write content to file.",
                            {"type": "object", "properties": {"path": {"type": "string"}, "content": {"type": "string"}}, "required": ["path", "content"]}),
            _to_openai_tool("edit_file", "Replace exact text in file.",
                            {"type": "object", "properties": {"path": {"type": "string"}, "old_text": {"type": "string"}, "new_text": {"type": "string"}}, "required": ["path", "old_text", "new_text"]}),
            _to_openai_tool("send_message", "Send message to a teammate.",
            ...
            _to_openai_tool("read_inbox", "Read and drain your inbox.",
                            {"type": "object", "properties": {}}),
            _to_openai_tool("shutdown_response", "Respond to a shutdown request.",
                            {"type": "object", "properties": {"request_id": {"type": "string"}, "approve": {"type": "boolean"}, "reason": {"type": "string"}}, "required": ["request_id", "approve"]}),
            _to_openai_tool("plan_approval", "Submit a plan for lead approval.",
                            {"type": "object", "properties": {"plan": {"type": "string"}}, "required": ["plan"]}),
            _to_openai_tool("idle", "Signal that you have no more work. Enters idle polling phase.",
                            {"type": "object", "properties": {}}),
            _to_openai_tool("claim_task", "Claim a task from the task board by ID.",
...
TOOLS = [
    ...
    _to_openai_tool("edit_file", "Replace exact text in file.",
                    {"type": "object", "properties": {"path": {"type": "string"}, "old_text": {"type": "string"}, "new_text": {"type": "string"}}, "required": ["path", "old_text", "new_text"]}),
    _to_openai_tool("spawn_teammate", "Spawn an autonomous teammate.",
                    {"type": "object", "properties": {"name": {"type": "string"}, "role": {"type": "string"}, "prompt": {"type": "string"}}, "required": ["name", "role", "prompt"]}),
    _to_openai_tool("list_teammates", "List all teammates.",
                    {"type": "object", "properties": {}}),
    _to_openai_tool("send_message", "Send a message to a teammate.",
                    {"type": "object", "properties": {"to": {"type": "string"}, "content": {"type": "string"}, "msg_type": {"type": "string", "enum": list(VALID_MSG_TYPES)}}, "required": ["to", "content"]}),
    _to_openai_tool("read_inbox", "Read and drain the lead's inbox.",
                    {"type": "object", "properties": {}}),
    _to_openai_tool("broadcast", "Send a message to all teammates.",
                    {"type": "object", "properties": {"content": {"type": "string"}}, "required": ["content"]}),
    _to_openai_tool("shutdown_request", "Request a teammate to shut down.",
                    {"type": "object", "properties": {"teammate": {"type": "string"}}, "required": ["teammate"]}),
    _to_openai_tool("shutdown_response", "Check shutdown request status.",
                    {"type": "object", "properties": {"request_id": {"type": "string"}}, "required": ["request_id"]}),
    _to_openai_tool("plan_approval", "Approve or reject a teammate's plan.",
                    {"type": "object", "properties": {"request_id": {"type": "string"}, "approve": {"type": "boolean"}, "feedback": {"type": "string"}}, "required": ["request_id", "approve"]}),
    _to_openai_tool("idle", "Enter idle state (for lead -- rarely used).",
                    {"type": "object", "properties": {}}),
    _to_openai_tool("claim_task", "Claim a task from the board by ID.",
                    {"type": "object", "properties": {"task_id": {"type": "integer"}}, "required": ["task_id"]}),
]
