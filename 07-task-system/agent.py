...
Builds on 06 by externalizing planning state to disk. When context
gets compressed, tasks remain intact because they live outside the conversation.
...
def agent_loop(messages: list):
    while True:
        ...
        for tc in message.tool_calls:
            ...
            messages.append({"role": "tool", "tool_call_id": tc.id, "name": name, "content": str(output)})
