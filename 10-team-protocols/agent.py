...
request_id correlation pattern. Builds on 09's team messaging.

The shutdown FSM lets the lead gracefully stop teammates.
The plan approval FSM lets teammates submit plans for lead review.
